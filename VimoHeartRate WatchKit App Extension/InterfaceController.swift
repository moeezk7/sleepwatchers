...
class InterfaceController: WKInterfaceController, HKWorkoutSessionDelegate {
    ...
    var currentHeartRateValue:Float = 70.0;

    @IBOutlet weak var myLabel: WKInterfaceLabel!
    
    @IBOutlet weak var mySlider: WKInterfaceSlider!
    @IBAction func sliderDidChange(_ value: Float) {
        self.currentHeartRateValue = value
        let displayValue = Int(self.currentHeartRateValue)
        myLabel.setText("\(displayValue)")
    }
    ...
    @IBOutlet var safe: WKInterfaceLabel!
    ...
    guard let heartRateSamples = samples as? [HKQuantitySample] else {return}
        ...
        DispatchQueue.main.async {
            ...
            if Float(value) <  (self.currentHeartRateValue * 0.93) {
